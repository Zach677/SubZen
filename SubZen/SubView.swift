...
struct SubView: View {
		...
		@Query(sort: [SortDescriptor(\Subscription.dateAdded, order: .reverse)]) private var subscriptions: [Subscription]
								...
								if subscriptions.isEmpty {
										...
										ContentUnavailableView(
												"No Subscriptions",
												 ...
												 description: Text("Tap the + button to add your first subscription.")
										)
								} else {
