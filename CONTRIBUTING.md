...
This document describes the process of contributing to SubZen. It is intended
for anyone considering opening an **issue**, **discussion** or **pull request**.
For people who are interested in developing SubZen and technical details behind
it, please check out our ["Developing SubZen"](HACKING.md) document as well.

> [!NOTE]
>
> I'm sorry for the wall of text. I'm not trying to be difficult and I do
> appreciate your contributions. SubZen is a personal project for me that
...
> [!IMPORTANT]
>
> The SubZen project allows AI-**assisted** _code contributions_, which
> must be properly disclosed in the pull request.

If you are using any kind of AI assistance while contributing to SubZen,
...
allowed, as it goes against the methodology and ethos behind SubZen.
...
If you intend to submit AI-generated assets to SubZen, sorry,
...
Community moderators and SubZen maintainers reserve the right to mark
...
["contributor friendly"]: https://github.com/Zach677/SubZen/issues?q=is%3Aissue%20is%3Aopen%20label%3A%22contributor%20friendly%22

### I'd like to translate SubZen to my language

We have written a [Translator's Guide](po/README_TRANSLATORS.md) for
everyone interested in contributing translations to SubZen.
...
[closed issues]: https://github.com/Zach677/SubZen/issues?q=is%3Aissue%20state%3Aclosed
[discussions]: https://github.com/Zach677/SubZen/discussions?discussions_q=is%3Aclosed
["Issue Triage"]: https://github.com/Zach677/SubZen/discussions/new?category=issue-triage
...
["Feature Requests, Ideas"]: https://github.com/Zach677/SubZen/discussions/new?category=feature-requests-ideas
...
those are for general discussion about terminals and SubZen development
...
> the ["Feature Requests, Ideas"] category. If SubZen is behaving
...
[Q&A discussion]: https://github.com/Zach677/SubZen/discussions/new?category=q-a
<!--[Discord Server]: https://discord.gg/SubZen-->

## General Patterns

### Issues are Actionable

The SubZen [issue tracker](https://github.com/Zach677/SubZen/issues)
is for _actionable items_.

Unlike some other projects, SubZen **does not use the issue tracker for
discussion or feature requests**. Instead, we use GitHub
[discussions](https://github.com/Zach677/SubZen/discussions) for that.
...
> working on SubZen.** If you're a user reporting an issue, you can
...
This contribution guide is inspired by the Ghostty project.
